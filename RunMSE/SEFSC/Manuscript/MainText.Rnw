...
library(knitr)
opts_chunk$set(fig.path='figures/plots-', fig.align='center', fig.show='hold', eval=TRUE, echo=FALSE)
...
<<admin, echo=FALSE,warning=FALSE,message=FALSE>>=
#load("../.RData")
library(english) # For english() function which converts numbers to words
library(Hmisc)
library(stringr)
library(tinytex)
...
texfig <- function(pdf_path="../Figs/myfigure.pdf",
                   caption_text="This is a caption.",
                   label="fig:myfigure",
                   width="6in",
                   height="7in"
                   ){
out <- paste0("\\begin{figure}[!ht]
\\begin{center}
\\includegraphics[width=",width,", height=",height,"]{",
pdf_path,
"}
\\end{center}
\\begin{flushleft}
...
<<latexTable, echo=FALSE>>=


@

<<parsForText, echo=FALSE>>=
# my wrapper function for formatting numbers with commas separating thousands
tn <- function(x){
  prettyNum(x,big.mark=",",scientific=FALSE)
  }

# Update these later based on saved results
n_sp <- english(3)
n_scen <- 23
n_MP <- 13
...
<<boxplots base,results=tex,echo=FALSE>>=
box_caption <- function(...){
  dots <- list(...)
  paste0("Box plots of ",
         dots[[1]],
         " for the base ",
         dots[[2]],
         " Grouped boxes represent sequential time periods during the projection period. Boxes represent interquartile range (IQR). Whiskers are drawn to $1.5\\times\\mathrm{IQR}$."
  )
  }

texfig("../Figs/boxplotSBSBMSY1.pdf",
       box_caption("$\\mathrm{SSB/SSB_{MSY}}$","scenario."),
       "fig:boxplotSBSBMSY1")

texfig("../Figs/boxplotFFMSY1.pdf",
       box_caption("$\\mathrm{F/F_{MSY}}$","scenario."),
       "fig:boxplotFFMSY1")

texfig("../Figs/boxplotCatchTotal1.pdf",
       box_caption("total catch (annual catches summed across each time period)","scenario."),
       "fig:boxplotCatchTotal1")

texfig("../Figs/boxplotAAVY1.pdf",
       box_caption("average annual variation in yield ($\\mathrm{AAVY}$)","scenario."),
       "fig:boxplotAAVY1")
@

<<tsplots base A and B,results=tex,echo=FALSE>>=
ts_caption <- function(...){
  dots <- list(...)
  paste0("Time series of ",
         dots[[1]],
         " among simulation runs for the base ",
         dots[[2]],
         "Vertical dotted lines indicate assessment years at ",
         dots[[3]]
         ," yr intervals."
  )
  }
...
for(i in 1){
# texfig(paste0("../Figs/tsCatch",i,".pdf"),
#        ts_caption("median $\\mathrm{catch}$","scenario.","10"),
#        paste0("fig:tsCatch",i))
# texfig(paste0("../Figs/tsCatch",i,"B.pdf"),
#        ts_caption("median $\\mathrm{catch}$","scenario.","5),
#        paste0("fig:tsCatch",i,"B"))


texfig(paste0("../Figs/tsCatchMSY",i,".pdf"),
       ts_caption("median $\\mathrm{catch/MSY}$","scenario.","10"),
       paste0("fig:tsCatchMSY",i)
       )

texfig(paste0("../Figs/tsCatchMSY",i,"B.pdf"),
       ts_caption("median $\\mathrm{catch/MSY}$","scenario.","5"),
       paste0("fig:tsCatchMSY",i,"B"))

texfig(paste0("../Figs/tsFFmsy",i,".pdf"),
       ts_caption("median $\\mathrm{F/F_{MSY}}$","scenario.","10"),
       paste0("fig:tsFFmsy",i)
       )

texfig(paste0("../Figs/tsFFmsy",i,"B.pdf"),
       ts_caption("median $\\mathrm{F/F_{MSY}}$","scenario.", "5"),
       paste0("fig:tsFFmsy",i,"B"))

texfig(paste0("../Figs/tsSSBSSBmsy",i,".pdf"),
       ts_caption("median $\\mathrm{SSB/SSB_{MSY}}$","scenario.","10"),
       paste0("fig:tsSSBSSBmsy",i)
       )

texfig(paste0("../Figs/tsSSBSSBmsy",i,"B.pdf"),
       ts_caption("median $\\mathrm{SSB/SSB_{MSY}}$","scenario.","5"),
       paste0("fig:tsSSBSSBmsy",i,"B"))
}
@


<<trplots base,results=tex,echo=FALSE>>=
tr_caption <- function(...){
  dots <- list(...)
  paste0("Trade off plots of",
         dots[[1]],
         " versus ",
         dots[[2]],
         " among simulation runs for the base ",
         dots[[3]],
         " Plots are based on data for the last 10 years of the projection period."
  )
  }

for(i in 1){
texfig(paste0("../Figs/trAAVYP100",i,".pdf"),
       tr_caption(" the probability that average annual variability in yield (AAVY) <20\\%,",
                  " the probability that $\\mathrm{SSB > SSB_{MSY}}$",
                  "scenario."),
       paste0("fig:trAAVYP100",i),
       width="7in",
       height="3.5in")

texfig(paste0("../Figs/trAAVYPNOF",i,".pdf"),
       tr_caption(" the probability that average annual variability in yield (AAVY) <20\\%,",
                  " the probability that $\\mathrm{F < F_{MSY}}$",
                  "scenario."),
       paste0("fig:trAAVYPNOF",i),
       width="7in",
       height="3.5in")


texfig(paste0("../Figs/trAAVYYldLT",i,".pdf"),
       tr_caption(" the probability that average annual variability in yield (AAVY) <20\\%,",
                  " longterm yield",
                  "scenario."),
       paste0("fig:trAAVYYldLT",i),
       width="7in",
       height="3.5in")

texfig(paste0("../Figs/trP100YldLT",i,".pdf"),
       tr_caption(" the probability that $\\mathrm{SSB > SSB_{MSY}}$",
                  " longterm yield",
                  "scenario."),
       paste0("fig:trP100YldLT",i),
       width="7in",
       height="3.5in")

texfig(paste0("../Figs/trPNOFP100",i,".pdf"),
       tr_caption(" the probability that $\\mathrm{F < F_{MSY}}$ ",
                  " the probability that $\\mathrm{SSB > SSB_{MSY}}$",
                  "scenario."),
       paste0("fig:trPNOFP100",i),
       width="7in",
       height="3.5in")
...
<<phaseplots base,results=tex,echo=FALSE>>=
ph_caption <- function(...){
  dots <- list(...)
  paste0("Phase plots of",
         dots[[1]],
         " versus ",
         dots[[2]],
         " among simulation runs for the base ",
...
for(i in 1){
texfig(paste0("../Figs/phasePlot",i,".pdf"),
       ph_caption(" the probability that $\\mathrm{F > F_{MSY}}$ ",
                  " the probability that $\\mathrm{SSB > SSB_{MSY}}$",
                  "scenario."),
       paste0("fig:phasePlot",i),
       width="7in",
       height="3.5in")
}
@
...
<<boxplots appendix,results=tex,echo=FALSE>>=
#caption_expr <- expression(paste("scenario and group", i, "alternative scenarios."))
caption_expr <- expression(paste("and alternative scenarios."))

for(i in 2){
texfig(paste0("../Figs/boxplotSBSBMSY",i,".pdf"),
       box_caption("$\\mathrm{SSB/SSB_{MSY}}$",
                   eval(caption_expr)),

       paste0("fig:boxplotSBSBMSY",i))

texfig(paste0("../Figs/boxplotFFMSY",i,".pdf"),
       box_caption("$\\mathrm{F/F_{MSY}}$",
                   eval(caption_expr)),
       paste0("fig:boxplotFFMSY",i))

texfig(paste0("../Figs/boxplotCatchTotal",i,".pdf"),
       box_caption("total catch (annual catches summed across each time period)",
                   eval(caption_expr)),
       paste0("fig:boxplotCatchTotal",i))

texfig(paste0("../Figs/boxplotAAVY",i,".pdf"),
       box_caption("average annual variation in yield ($\\mathrm{AAVY}$)",
                   eval(caption_expr)),
       paste0("fig:boxplotAAVY",i))
}
@

<<tsplots appendix A and B,results=tex,echo=FALSE>>=
for(i in 2){
# texfig(paste0("../Figs/tsCatch",i,".pdf"),
#        ts_caption("median $\\mathrm{catch}$","scenario.","10"),
#        paste0("fig:tsCatch",i))
...
<<trplots appendix,results=tex,echo=FALSE>>=
for(i in 2){
texfig(paste0("../Figs/trAAVYP100",i,".pdf"),
       tr_caption(" the probability that average annual variability in yield (AAVY) <20\\%,",
                  " the probability that $\\mathrm{SSB > SSB_{MSY}}$",
...
<<phaseplots appendix,results=tex,echo=FALSE>>=
for(i in 2){
texfig(paste0("../Figs/phasePlot",i,".pdf"),
       ph_caption(" the probability that $\\mathrm{F > F_{MSY}}$ ",
                  " the probability that $\\mathrm{SSB > SSB_{MSY}}$",
