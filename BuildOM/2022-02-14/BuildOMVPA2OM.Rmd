  ...
  CurrentYr_i = parms_i$endyr
          ...
          if(run_rdat_to_Obs){
            ...
            ObsUser <- rdat_to_Obs(
                            rdat=my_rdat,
                            Obs=ObsUser,
                            Ind_abb=c("CVID","CVT","Mcvt","sCT","sM","VID"),
                            CAA_abb=c("CVID","CVT","Mcvt","sCT","sM","VID"),
                            CAL_abb=c("CVID","CVT","Mcvt","sCT","sM","VID")
                            )
          }
        }
...
for(OM_name_i in OM_name_bam){
  ...
  saveRDS(OM_i,file=file.path("OM","SEFSC",paste0(OM_name_i,OM_name_suffix,".rds")),compress=FALSE)
  }
